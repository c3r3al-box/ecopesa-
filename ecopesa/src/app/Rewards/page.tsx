// app/rewards/page.tsx (if you're using the app directory)

export const metadata = {
  title: 'EcoPesa - Rewards',
  description: 'View and redeem your EcoPesa points for exciting rewards.',
}
    ...
    <div className="min-h-screen bg-emerald-50">
      ...
      <section className="bg-white p-6 mx-4 mt-6 rounded-lg shadow-sm border border-emerald-100">
        <div className="text-center">
          ...
          <p className="text-gray-500 text-sm">≈ Ksh12.50</p>
        </div>
      </section>
      ...
      <section className="p-4 mt-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          {[
            { title: '$5 Shopping Voucher', points: 500 },
            { title: 'Eco Water Bottle', points: 800 },
            { title: '$10 Cash', points: 1000 },
            { title: 'Eco Tote Bag', points: 1200 },
          ].map((reward, index) => (
            <div
              key={index}
