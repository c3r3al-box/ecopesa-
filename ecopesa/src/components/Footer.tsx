    ...
    <footer className="bg-emerald-800 text-white">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-bold flex items-center">
              <RecycleIcon className="h-6 w-6 mr-2" />
              EcoPesa
            </h3>
            <p className="text-emerald-100">
              Turning waste into rewards for a greener planet.
            </p>
          ...
          <FooterSection 
            ...
            links={[
              { name: 'Home', href: '/' },
              { name: 'Collection Centers', href: '/centers' },
          ...
          <div className="space-y-4">
            ...
            <p className="text-emerald-100">
              Subscribe to get updates on new rewards and features.
            </p>
            <NewsletterForm />
          </div>
        </div>
        ...
        <div className="border-t border-emerald-700 mt-8 pt-6 text-center text-emerald-100">
          <p>&copy; {currentYear} EcoPesa. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
...
const NewsletterForm = () => (
  <form className="space-y-2">
    ...
    <button 
      type="submit"
      className="bg-emerald-600 px-4 py-2 rounded-r hover:bg-emerald-700 w-full flex justify-center"
    >
      Subscribe
    </button>
  </form>
